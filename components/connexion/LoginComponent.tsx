...
export default function LoginComponent() {
  ...
  return (
    <div className="w-full flex gap-6 bg-white min-h-screen">
      ...
      <div className="flex-1 flex justify-center p-10 bg-gradient-to-r from-[#6B2CF5] to-[#8B5CF6]">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)}>
                <div className="flex flex-col gap-6">
                  ...
                  {showForgot && (
                    <Link
                      href={'#forgot'}
                      className="text-center text-sm text-[var(--primary-color)] hover:underline"
                    >
                      Mot de passe oublié ?
                    </Link>
                  )}
