...
import CvModification from './CvModification';
...
export default function CvMinuteContent() {
  ...
  if (context)
    return (
      <div>
        ...
        {showConditions && (
          <Popup large onClose={() => setShowConditions(false)}>
              ...
              <div>
                ...
                <div>
                  <p className="text-justify">
                    ...
                    tous vos CV via Profil First dès le lendemain de leur
                    création Votre CV reste anonyme jusqu’à ce que vous
                    acceptiez un rendez-vous. Vous pouvez refuser un
                    rendez-vous, votre anonymat est préservé. Si vous activez
                    Quali Carrière CV : nous allons créer un CV personnalisé en
                    fonction des offres des recruteurs Tous les CV créés par
                    l’IA vous sont fournis si un recruteur souhaite planifier un
                    rendez-vous. Lorsqu’un recruteur vous contact via Profil
                    First, vous recevez un mail sur votre mail d’inscription.
                    Tous les CV créés par l’IA vous sont fournis si un recruteur
                    souhaite planifier un rendez-vous. Vous recevez des conseils
                    de préparation à l’entretien en basés sur le CV sélectionné
                    par le recruteur
                  </p>
                </div>
              </div>
