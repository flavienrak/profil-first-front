            ...
            <div className="flex justify-end">
              <div className="flex items-center gap-[1em] p-[0.25em] rounded-[0.5em] bg-white shadow">
                ...
                <p
                  ...
                  className="h-full px-[1em] flex justify-center items-center text-white text-[0.875em] rounded-[0.35em] bg-[#2A7F8B] select-none hover:opacity-90 cursor-pointer"
                >
                  Reset
                </p>
              </div>
                        ...
                        fields: [
                          {
                            ...
                            initialValue: title?.sectionInfos[0]?.content ?? '',
                          },
                        ],
                      };
                        ...
                        fields: [
                          {
                            ...
                            placeholder:
                              ...
                              'Présentation...',
                            value: presentation?.sectionInfos[0]?.content ?? '',
                            initialValue:
                              presentation?.sectionInfos[0]?.content ?? '',
                          },
                        ],
