            ...
            <div className="p-4 border-b border-gray-200 space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#6B2CF5] focus:ring-2 focus:ring-[#6B2CF5]/20"
                />
              </div>
              <div className="relative">
            ...
            <div className="flex border-b border-gray-200">
              <button
                className={`flex-1 py-3 text-sm font-medium flex items-center justify-center gap-2 ${
                  activeTab === 'unread'
                    ? 'text-[#6B2CF5] border-b-2 border-[#6B2CF5]'
                        ...
                        <div className="flex items-center justify-between mb-1">
                          <h3 className="font-semibold text-gray-900 truncate">
                            <span
                              className={
                                !conversation.isRead
                                  ? 'bg-[#6B2CF5]/10 px-2 py-0.5 rounded-md'
                                  : ''
                              }
                            >
                          ...
                          <div className="flex items-center gap-2">
                            {conversation.isRead ? (
                              <CheckCheck className="w-4 h-4 text-[#6B2CF5]" />
                            ) : (
