      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <Building2 className="w-8 h-8 text-[#6B2CF5]" />
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 ml-auto">
              <Image
                ...
                className="w-16 h-16"
              />
              <button className="px-6 py-3 bg-gradient-to-r from-[#6B2CF5] to-[#08EEDE] text-white rounded-lg hover:opacity-90 transition-opacity shadow-md">
        ...
        <div className="space-y-6">
          <h3 className="text-xl font-semibold flex items-center gap-2">
            <span className="w-2 h-2 bg-[#6B2CF5] rounded-full"></span>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h4 className="font-semibold mb-4 flex items-center gap-2">
                <Users2 className="w-5 h-5 text-[#6B2CF5]" />
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h4 className="font-semibold mb-4 flex items-center gap-2">
                <Star className="w-5 h-5 text-[#6B2CF5]" />
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h4 className="font-semibold mb-4 flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-[#6B2CF5]" />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start gap-2">
                      <Code className="w-5 h-5 text-[#6B2CF5] mt-1" />
                      <span>
                        Refonte complète de l'architecture microservices
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Target className="w-5 h-5 text-[#6B2CF5] mt-1" />
                      <span>Réduction de 40% du temps de déploiement</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Users2 className="w-5 h-5 text-[#6B2CF5] mt-1" />
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-[#6B2CF5]/10 text-[#6B2CF5] rounded-full text-sm">
                      React.js
                    </span>
                    <span className="px-3 py-1 bg-[#6B2CF5]/10 text-[#6B2CF5] rounded-full text-sm">
                      Node.js
