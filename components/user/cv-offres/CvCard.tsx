          ...
          <button
            ...
            className={`flex items-center w-full justify-center gap-2 px-3 py-2 rounded-lg text-[var(--primary-color)] transition-all ${
              redirectLoading
                ...
                : 'hover:bg-[var(--primary-color)]/5 cursor-pointer'
            }`}
          >
            {redirectLoading ? (
              <svg
          ...
          <div className="flex flex-col gap-8 bg-white rounded-xl p-8 max-w-lg w-full text-center">
            ...
            <div className="flex justify-center gap-4">
              <Link
                ...
                className={`flex-1 flex items-center justify-center gap-2 px-8 py-1 border border-[var(--primary-color)] text-[var(--primary-color)] font-semibold rounded-full select-none ${
                  redirectLoading
                    ? 'opacity-80 pointer-events-none'
