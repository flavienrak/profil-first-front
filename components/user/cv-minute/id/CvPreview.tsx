        ...
        <div className="w-full px-8 h-20 border-b border-gray-200 bg-white flex items-center">
          <div className="w-full flex justify-center items-center gap-5">
            ...
            <button
              ...
              className="step-6 flex justify-center items-center gap-2 h-12 py-3 ps-4 pe-6 font-semibold rounded-sm text-sm text-white bg-gradient-to-r from-[#6B2CF5] to-[#8B5CF6] hover:opacity-80 cursor-pointer select-none"
            >
              <Download size={20} />
