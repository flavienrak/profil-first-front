...
import StepLoader from '@/components/quali-carriere/step/StepLoader';
import ChatContent from '@/components/quali-carriere/step/chat/ChatContent';
        ...
        <div className="flex max-h-full flex-col gap-6 p-8 bg-gradient-to-br from-[#6B2CF5]/5 to-purple-50 rounded-xl shadow-lg overflow-hidden">
          <div className="flex items-center justify-between">
            ...
            {edit ? (
              <div
                onClick={handleSave}
                className={`flex items-center justify-center gap-1 py-2 px-3 text-xs text-white bg-[var(--primary-color)] rounded-full hover:opacity-80 select-none ${
                  saveLoading
              ...
              <div
                ...
                className="flex items-center justify-center gap-1 py-2 px-3 text-xs text-white bg-[var(--primary-color)] rounded-full hover:opacity-80 select-none cursor-pointer"
              >
                <i>
                  <Edit size={14} />
                </i>
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className={`absolute right-2 top-[0.425rem] w-8 h-8 text-white bg-[var(--primary-color)] rounded-full flex items-center justify-center ${
                      isLoading
                        ? 'opacity-80 pointer-events-none'
