    ...
    <div className="min-h-full w-full flex flex-col gap-8 p-8">
      <div className="flex items-center justify-between">
        ...
        <div>
          <Link
            href={'/quali-carriere'}
            className="px-6 py-3 p-[0.5em] bg-gradient-to-r from-[#6B2CF5] to-[#8B5CF6] rounded-md transition-opacity duration-300 select-none hover:opacity-80 cursor-pointer text-white"
          >
