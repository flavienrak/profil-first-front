...
import QualiCarriereChat from './QualiCarriereChat';
  ...
  if (context)
    return (
      <div className="relative h-full w-full max-h-full overflow-y-auto p-8">
        {context.currentQuery?.step &&
        !isNaN(Number(context.currentQuery.step)) ? (
          <>
            {Number(context.currentQuery.step) === 1 ? (
              <QualiCarriereChat setRedirectLoading={setRedirectLoading} />
            ) : (
              <QualiCarriereSynthese setRedirectLoading={setRedirectLoading} />
            )}
          </>
        ) : (
          <>
            <div className="flex justify-center">
              <div className="max-w-6xl flex flex-col gap-10">
                <div className="flex flex-col gap-8">
                  <h1 className="text-4xl font-bold text-center bg-gradient-to-r from-[#4461F2] to-[#6B7FFF] bg-clip-text text-transparent">
                    Quali Carrière CV
                  </h1>
                  <div className="flex items-center justify-between mb-4">
                    <p className="text-lg">
                      Candidatez avec un CV adapté aux offres d'emploi sans
                      effort
                    </p>
                    <button
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="flex gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <p>
                            Vous validez les éléments de votre parcours. Vous
                            pouvez en discuter dans le Chat de Profiler Coach.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-4">
                        ...
                        <div>
                          <p className="font-semibold">
                            ...
                            version de votre parcours en CV aux recruteurs selon
                            les offres d'emploi.
                          </p>
                        </div>
                      </div>
                ...
                <div className="flex flex-col items-center gap-10">
                  ...
                  <div className="flex flex-col gap-7 bg-white p-6 rounded-xl shadow-md text-center w-full max-w-xl">
                    ...
                    <p className="">
                      ...
                      professionnel pour faire ressortir les meilleures
                      informations de votre profil.
                    </p>
                    <button
                      onClick={handleShowChat}
                      className={`w-full flex items-center justify-center gap-3 px-6 py-3 bg-gradient-to-r from-[#6B2CF5] to-[#8B5CF6] text-white rounded-full ${
                        redirectLoading
                          ? 'opacity-80'
                      ...
                      <div className="flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <p className="text-gray-600">
                            ...
                            découvrent votre identité si vous acceptez la prise
                            de contact.
                          </p>
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <p className="text-gray-600">
                            Profil First vous donne des conseils personnalisés
                            pour parler de votre parcours tout en restant aligné
                            avec votre nouveau CV ia
                          </p>
                        </div>
                      </div>
                      <div className="flex flex-col gap-3 mt-8">
                        <p className="text-gray-600">
                          Quali Carrière permet à Profil First de générer un CV
                          de votre profil qui est optimisé pour l'offre d'emploi
                          du recruteur.
                        </p>
                        <p className="text-gray-600">
                          Après une discussion approfondie sur vos expériences
                          avec Profiler Coach Ai, Profil First va créer un CV
                          personnalisé en fonction de chaque offre d'un
                          recruteur.
                        </p>
                        <p className="text-gray-600">
                          Si un recruteur est intéressé par ce CV, alors il vous
                          enverra un message et vous aurez évidemment accès à ce
                          CV afin de prépar vos échanges avec le recruteur.
                        </p>
                        <p className="text-gray-600 mt-6 text-sm italic">
                          Vous pouvez désactiver Quali Carrière quand vous
                          voulez
                        </p>
                      </div>
                    </div>
