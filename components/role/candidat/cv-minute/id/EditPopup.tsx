...
import {
  FieldInterface,
  PopupInterface,
} from '@/components/role/candidat/cv-minute/id/CvPreview';
import { updateCvMinuteSectionService } from '@/services/role/candidat/cvMinute.service';
import { isSameData } from '@/lib/utils';
import { useDispatch, useSelector } from 'react-redux';
import {
  updateCvMinuteReducer,
  updateCvMinuteSectionReducer,
} from '@/redux/slices/role/candidat/cvMinute.slice';
