...
import { updateCvThequeCritereService } from '@/services/role/recruiter/cvtheque.service';
import { setCvThequeCritereReducer } from '@/redux/slices/role/recruiter/cvtheque.slice';
import { isArraysEqual } from '@/lib/function';
import { CvCritereFormValues, cvCritereSchema } from '../CvThequeComponent';
...
export default function CvThequeDetails() {
  ...
  const onSubmit = async (data: CvCritereFormValues) => {
    ...
    if (parseRes.success && cvThequeCritere) {
      ...
      const dataToUpdate: UpdatePayload = Object.fromEntries(
        simpleFields
  ...
  return (
    <div className="relative min-h-full w-full flex gap-6 py-8 px-12 bg-[#faf7f5]">
                    ...
                    <FormItem>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <PopoverContent align="start" className="rounded-lg">
      ...
      <div className="flex-1 flex flex-col gap-4 bg-white rounded-lg shadow-sm p-4">
