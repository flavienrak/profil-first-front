                ...
                >
                  ...
                  <td className="px-6 py-4 border-r border-gray-100">
                    {app.rdvStatus === 'En attente' ? (
                      ...
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium shadow-sm bg-gradient-to-r from-[var(--u-primary-color)] to-[#8B5CF6] text-white">
                        ✉️ Nouveau message
                      </span>
                    ) : (
