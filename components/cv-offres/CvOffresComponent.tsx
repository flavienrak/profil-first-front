...
import { getAllCvMinuteService } from '@/services/cvMinute.service';
    ...
    <div className="min-h-full w-full px-12 py-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          className="px-6 py-3 text-sm bg-gradient-to-r from-[#6B2CF5] to-[#8B5CF6] text-white rounded-full transition-opacity duration-150 select-none cursor-pointer hover:opacity-80"
        >
