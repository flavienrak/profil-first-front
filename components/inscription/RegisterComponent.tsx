...
export default function RegisterComponent() {
  ...
  const roles: { title: string; value: 'user' | 'recruiter' }[] = [
    { title: 'Utilisateur', value: 'user' },
    { title: 'Recruteur', value: 'recruiter' },
  ];
  ...
  const changeRole = (value: 'user' | 'recruiter') => {
    setValue('role', value);
  };
  ...
  return (
    <div className="w-full flex gap-6 bg-white min-h-screen">
      <div className="flex-1 relative flex justify-center items-center p-10">
        <div className="absolute top-4 left-4">
          <Logo href={'/'} />
        </div>
      </div>
      <div className="flex-1 flex justify-center p-10 bg-gradient-to-r from-[#4461F2] to-[#6B7FFF]">
        <div className="flex flex-col gap-10 justify-center items-center w-full max-w-[400px]">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex gap-5">
                    {roles.map((item) => (
                      <Button
                        key={item.value}
                        className={`flex-1 text-center text-sm h-12 rounded-lg ${
                          item.value === form.watch('role')
                            ? 'bg-gradient-to-r from-[#4461F2] to-[#6B7FFF] text-white'
                            : 'bg-transparent text-black border hover:text-[var(--primary-color)] hover:border-[var(--primary-color)] hover:bg-transparent transition-all duration-250 cursor-pointer'
                        }`}
                  ...
                  <Button
                    type="submit"
                    className={`py-6 bg-gradient-to-r from-[#4461F2] to-[#6B7FFF] ${
                  ...
                  >
                    <p>
                      ...
                      <span className="font-semibold text-lg">S'inscrire</span>
                    </p>
                  </Button>
                </div>
              </form>
